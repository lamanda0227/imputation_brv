...
DSC:
  ...
  global:
    ...
    hrc_topmed_exome_folder:    "~/project/imputation-rvtest/workflows/imputation_aggregated_analysis/gene/hrc_topmed_exome_rsq03"
    hrc_topmed_folder:          "~/project/imputation-rvtest/workflows/imputation_aggregated_analysis/gene/hrc_topmed_rsq03"
